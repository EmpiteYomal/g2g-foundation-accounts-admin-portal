...
import { ArrowRight, ArrowLeft, ShieldCheck, HandCoins, BarChart3, Eye, EyeOff, Check, Mail } from "lucide-react";

const features = [
  {
    icon: BarChart3,
    title: "Bank Reconciliation",
    desc: "Match incoming funds to company foundation accounts with auto-matching for known bank accounts.",
  },
  {
    icon: HandCoins,
    title: "Fund Transfer Management",
    desc: "Approve charity allocations and generate ABA files for each fund transfer.",
  },
  {
    icon: ShieldCheck,
    title: "Company & Charity Oversight",
    desc: "Manage company sign-ups, charity access, and maintain full audit transparency.",
  },
];

const trustBadges = [
  "Goodstack Admin Access",
        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          <div className="mb-10">
            ...
            <h1 className="text-4xl xl:text-5xl font-bold text-foreground leading-tight tracking-tight mb-5">
              Manage foundation accounts{" "}
              <span className="text-primary">with full control.</span>
            </h1>

            <p className="text-muted-foreground text-base leading-relaxed max-w-sm">
              The Goodstack Admin Portal gives your team complete oversight of company
              foundation accounts — reconciliation, fund transfers, and charity management.
            </p>
          </div>
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-muted-foreground text-base mt-1">
                    Access is restricted to Goodstack admin staff.
                  </p>
                </div>
                ...
                <p className="text-center text-sm text-muted-foreground mt-6 leading-relaxed">
                  Admin access only. Unauthorised access is prohibited and{" "}
                  <span className="font-medium text-foreground">fully audited</span>.
                </p>
              </motion.div>
            )}
